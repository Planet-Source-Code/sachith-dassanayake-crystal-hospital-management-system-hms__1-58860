...
rsPatientID.Open "select * from Suppliers", cnPatients, adOpenDynamic, adLockPessimistic

rsPatient.Open "select * from Suppliers", cnPatients, adOpenDynamic, adLockPessimistic
