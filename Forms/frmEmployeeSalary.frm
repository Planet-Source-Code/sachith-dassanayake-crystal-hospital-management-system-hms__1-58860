...
Begin VB.Form frmEmployeeSalary 
   ...
   End
End
Attribute VB_Name = "frmEmployeeSalary"
...
Private Sub Form_Load()
  ...
  db.Open "PROVIDER=Microsoft.Jet.OLEDB.3.51;Data Source=C:\Crystal\Database\db2.mdb;"

  Set adoPrimaryRS = New Recordset
  adoPrimaryRS.Open "select Salary_ID,EmployeeID,basic,cca,da,gpf,hra,ins,itax,ptax,trans,gross,deduct,net from Employee_Salary", db, adOpenStatic, adLockOptimistic
