...
Begin VB.Form frmDisplayAdmissionDetails 
   BackColor       =   &H00FF8080&
   Caption         =   "View Admission Details"
   ClientHeight    =   10845
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11685
   Icon            =   "frmDisplayAdmissionDetails.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form3"
   MDIChild        =   -1  'True
   ScaleHeight     =   10845
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   795
         Left            =   2400
         Picture         =   "frmDisplayAdmissionDetails.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   1215
      ...
      Begin VB.CommandButton cmdSearch 
         ...
         Height          =   795
         Left            =   600
         Picture         =   "frmDisplayAdmissionDetails.frx":0D70
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   1215
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   795
         Left            =   4320
         Picture         =   "frmDisplayAdmissionDetails.frx":11F3
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   1215
   ...
   Begin ActiveResizeCtl.ActiveResize ActiveResize1 
      ...
      FormHeightDT    =   11355
      FormWidthDT     =   11805
      FormScaleHeightDT=   10845
      FormScaleWidthDT=   11685
   ...
   End
End
Attribute VB_Name = "frmDisplayAdmissionDetails"
...
'make the search
        strSQl = "SELECT * FROM Admission_Details WHERE "
...
rsPatientID.Open "select * from Admission_Details", cnPatients, adOpenDynamic, adLockPessimistic
